(function() {
    ...
    window.SOP_DATA.push({
        ...
        sections: [
            {
                ...
                <h3>Überwachungsmodalität (Früherkennung)</h3>
            ...
            },
            {
                ...
                <ul>
                    ...
                    <li><strong>Prädiktive molekularre Analysen:</strong> Sind in der regulären Diagnostik noch nicht verpflichtend, können aber zur erweiterten Therapieplanung (insbesondere im molekularen Tumorboard) eingesetzt werden.</li>
                </ul>`
            },
            {
                ...
                <p>Jeder Patient muss vor Therapiebeginn und bei Änderung der Therapiestrategie in einer <strong>interdisziplinären Tumorkonferenz</strong> vorgestellt werden.</p>`
            },
            {
                ...
                <h3>Perkutane Ablation (RFA / MWA)</h3>
                <ul>
        ...
        sources: "S3-Leitlinie Diagnostik und Therapie des Hepatozellulären Karzinoms und biliären Karzinome. Kurzversion 5.2 - Juni 2025. AWMF-Registernummer: 032-053OL. Herausgeber: Leitlinienprogramm Onkologie (DKG, DKH, AWMF)."
    });
})();
